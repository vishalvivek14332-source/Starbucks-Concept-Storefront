...
import { LogoFrameSection } from './components/LogoFrameSection';
  ...
  return (
    <div className="min-h-screen bg-[#0B4530] text-white flex flex-col font-sans selection:bg-[#00A862] selection:text-white">
      ...
      <main className="flex-1 flex flex-col justify-center">
        ...
        {/* 3D Siren Logo Frame Rectangular Slide Section at Bottom */}
        <LogoFrameSection
          onOpenStoreLocator={() => setActiveTab('store-locator')}
